...
#define DRIVER_VERSION		"v1.0.15_H264_v2.6.36.04"
#elif LINUX_VERSION_CODE == KERNEL_VERSION (2,6,30)
#define DRIVER_VERSION		"v1.0.15_H264_v2.6.30"
#elif LINUX_VERSION_CODE == KERNEL_VERSION (2,6,28)
#define DRIVER_VERSION		"v1.0.15_H264_v2.6.28"
#else
#define DRIVER_VERSION		"v1.0.15_H264_v2.6.21.03"
#endif
		     ...
		     const struct usb_device_id *id)
{
	...
	// Adding & Mapping  XU controls to uvc driver
	uvc_xu_ctrl_init(dev);

	// ------------------------------------------------
	// XU Ctrl: Asic read Chip ID
	dev->RER_Chip = 0;
	ret = uvc_xu_ctrll_ReadChip(dev, &dev->RER_Chip);
